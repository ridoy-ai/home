    ...
    return (
        <div name='skills' className='w-full h-screen bg-theme-dark-slate text-[#f9fafc]'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div class='max-w-[1000px] w-full gap-4 px-2 mt-4 pl-4 sm: pl-0 text-justify flex flex-col'>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
                        ...
                        <p class='text-left sm:text-left sm:block'>Machine Learning, Computer Vision, Mobile App Development, Program Optimization.</p>
                    </div>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
